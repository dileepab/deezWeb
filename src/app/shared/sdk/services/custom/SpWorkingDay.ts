...
/**
 * Api services for the `SpWorkingDay` model.
 */
@Injectable()
export class SpWorkingDayApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `SpWorkingDay` object.)
   * </em>
   */
  ...
  /**
   * Statistical information for spWorkingDay registers.
   *
