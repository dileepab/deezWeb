...
/**
 * Api services for the `ImageFile` model.
 */
@Injectable()
export class ImageFileApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `ImageFile` object.)
   * </em>
   */
  ...
  /**
   * Statistical information for ImageFile registers.
   *
