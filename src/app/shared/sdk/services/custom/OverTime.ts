...
/**
 * Api services for the `OverTime` model.
 */
@Injectable()
export class OverTimeApi extends BaseLoopBackApi {
  ...
  /**
   * Statistical information for OverTime registers.
   *
