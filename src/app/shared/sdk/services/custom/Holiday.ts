...
/**
 * Api services for the `Holiday` model.
 */
@Injectable()
export class HolidayApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `Holiday` object.)
   * </em>
   */
  ...
  /**
   * Statistical information for Holiday registers.
   *
