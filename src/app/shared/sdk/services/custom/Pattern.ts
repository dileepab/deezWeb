...
/**
 * Api services for the `Pattern` model.
 */
@Injectable()
export class PatternApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `Pattern` object.)
   * </em>
   */
  ...
  /**
   * Statistical information for pattern registers.
   *
